...
# Define the paths
input_file_path = '/mnt/c/Users/Utente/MAPD-B/project/A9_8_shift30.txt'
output_file_path = './corr_organized/A9_8_shift30_org.xlsx'
...
metrics_data = re.split(r'Correlation coefficients for metrics ', data)[1:]
